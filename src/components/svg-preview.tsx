...
export function SVGpreview({
  ...
  return (
    <div className="bg-muted-background px-4 pt-4 rounded-sm flex flex-col justify-between group">
      <div className="flex items-center justify-center flex-1">
        <div className="rounded-sm relative overflow-hidden">
          <img src={url} className="max-h-40" />
      ...
      <div className="py-4">
        <Text variant="sub-title">{name}</Text>
      </div>
    </div>
  );
}
